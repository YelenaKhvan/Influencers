            ...
            <div class="single_slider  d-flex align-items-center slider_bg_1">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="logo1">
                                <img src="/img/banner/Group.svg" alt="influencers">
                            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="course_all_btn text-center">
                        <a href="Courses.html" class="boxed-btn4">View All
                            course</a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="coures_info">
                            ...
                            <div class="coures_wrap d-flex">
                                <div class="single_wrap">
                                    ...
                                    <h4>Bachelor of <br>
                                        Graphic Design</h4>
                                    <p>Lorem ipsum dolor sit amet, sectetur
                                        adipiscing elit, sed do eiusmod tpor
                ...
                <div class="col-lg-10">
                    <div class="single_event d-flex align-items-center">
                        ...
                        <div class="event_info">
                            ...
                            <p><span> <i class="flaticon-clock"></i> 10:30
                                    pm</span> <span> <i class="flaticon-calendar"></i> 21Nov
                                    2020 </span> <span> <i class="flaticon-placeholder"></i> AH
                                    Oditoriam</span> </p>
                        </div>
                    </div>
                    <div class="single_event d-flex align-items-center">
                        ...
                        <div class="admission_form">
                            ...
                            <form action="#">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="apply_btn">
                                            <button class="boxed-btn3" type="submit">Apply
                                                Now</button>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-md-6">
                    <div class="single__news">
                        ...
                        <div class="news_info">
                            ...
                            <p class="d-flex align-items-center"> <span><i class="flaticon-calendar-1"></i> May
                                    10, 2020</span>

                                <span> <i class="flaticon-comment"></i> 01
                                    comments</span>
                            </p>
                        </div>
                    </div>
